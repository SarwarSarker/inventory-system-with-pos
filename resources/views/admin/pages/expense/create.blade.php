                ...
                <form action="{{ route('expense.store') }}" method="post">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="exampleInputdetails1" placeholder="Enter Details" name="details" ></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputAmount1">Amount</label>
                      <input type="text" class="form-control" id="exampleInputAmount1" placeholder="Enter  Amount" name="amount" > 
                    </div>
                    <div class="form-group">
